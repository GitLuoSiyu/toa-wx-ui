...
Component({
    ...
    methods: {
        ...
        reduceTap() {
            this.data.count - this.properties.step <= this.properties.min ? this.data.count = this.properties.min : this.data.count -= this.properties.step, this.setData({
        ...
        addTap() {
            this.data.count + this.properties.step >= this.properties.max ? this.data.count = this.properties.max : this.data.count += this.properties.step, this.setData({
                result: this.data.count
            }), this.triggerEvent("lintap", {
                count: this.data.result,
                type: "add"
